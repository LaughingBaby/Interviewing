...
#### 20. record lock、gap lock、next-key lock 和 insert intention lock 怎么讲？
...
### 22. 事务持久化模块：redo、undo、binlog 与恢复

#### 22. redo log、undo log、binlog 分别做什么？
