...
## 一、Go 当前能力全景：类型、集合、接口、错误、context 与高级特性

> 先掌握 Go 语言能提供什么能力，再讲底层和工程取舍。
...
## 二、Go 核心原理分析：slice、map、defer、panic 与 context 边界

> 这一章回答“为什么这样工作”：底层结构、运行语义和常见坑。
...
## 三、Go 工程实战：分层、接口、测试、依赖与性能

> 这一章回答“怎么把 Go 用好”：工程结构、边界和质量保障。

### P0 补充：HTTP/RPC 超时、连接池与工程并发边界
...
## 四、项目实战表达：把 Go 能力讲成项目价值

> 这一章用于项目深挖，突出你在真实业务中的 Go 工程能力。
